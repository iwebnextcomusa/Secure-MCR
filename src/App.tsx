...
export default function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ["home", "about", "services", "products", "why-choose-us", "testimonials", "faq", "contact"];
  ...
  const renderWhyIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case "Tag":
        return <Tag className="w-6 h-6 text-blue-400" />;
      case "FileText":
      ...
      case "ThumbsUp":
        return <ThumbsUp className="w-6 h-6 text-blue-400" />;
      default:
        return <CheckCircle className="w-6 h-6 text-blue-400" />;
    }
  };
  ...
  const renderProductGraphic = (type: string) => {
    return (
      <div className="relative w-full h-48 rounded-2xl bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-800/80 overflow-hidden flex items-center justify-center group-hover:border-blue-500/20 transition-all duration-300">
        <div className="absolute inset-0 bg-scanlines opacity-5"></div>
        {/* Radar scanner sweep line effect */}
        <div className="absolute left-0 right-0 h-0.5 bg-blue-500/10 shadow-[0_0_15px_#3b82f6] animate-scanline pointer-events-none"></div>
        ...
        {type === "ptz" && (
          <svg className="w-24 h-24 text-blue-400/80 stroke-1" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            <circle cx="12" cy="10" r="6" />
            <path d="M12 16v5M9 21h6" />
            <circle cx="12" cy="10" r="2" className="fill-blue-500/10 animate-pulse" />
        ...
        {(type === "kit2" || type === "kit4" || type === "kit8") && (
          <div className="relative flex items-center justify-center gap-2">
            <svg className="w-16 h-16 text-blue-400/80 stroke-1" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" />
              <path d="M3.27 6.96L12 12.01l8.73-5.05M12 22.08V12" />
            </svg>
            <div className="absolute -bottom-1 bg-blue-600/20 text-blue-400 border border-blue-500/30 font-mono text-[9px] px-2 py-0.5 rounded-full font-bold">
        ...
        {type === "wireless" && (
          <svg className="w-24 h-24 text-blue-400/80 stroke-1" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <rect x="9" y="14" width="6" height="8" rx="1" className="fill-blue-500/5" />
            <circle cx="12" cy="17" r="1" className="fill-blue-400" />
          </svg>
        )}
        ...
        {type === "dome" && (
          <svg className="w-24 h-24 text-blue-400/80 stroke-1" viewBox="0 0 24 24" fill="none" stroke="currentColor">
            ...
            <circle cx="12" cy="12" r="4" className="fill-blue-500/10" />
            <circle cx="12" cy="12" r="1.5" className="fill-blue-400 animate-pulse" />
          </svg>
        )}

        {/* Dynamic status badges in card overlay */}
        <div className="absolute top-3 left-3 bg-slate-950/80 border border-slate-800 text-[9px] font-mono font-semibold px-2 py-0.5 rounded-md text-blue-400 flex items-center gap-1">
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between scroll-smooth relative selection:bg-blue-600/30 selection:text-white font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-3 cursor-pointer select-none" onClick={() => scrollTo("home")}>
              <div className="relative flex items-center justify-center w-10 h-10 bg-blue-600 rounded shadow-lg shadow-blue-500/20">
                <Shield className="w-5.5 h-5.5 text-white" />
                <span className="absolute top-1 right-1 w-2 h-2 bg-red-500 rounded-full border border-slate-900 animate-led-blink"></span>
              </div>
              <div>
                <h1 className="text-xl font-extrabold tracking-tight text-white block uppercase leading-none">
                  SECURE <span className="text-blue-500">MCR</span>
                </h1>
            ...
            <nav className="hidden lg:flex items-center gap-8 text-sm font-medium">
              {[
                ...
                <button
                  ...
                  className={`py-1 text-sm font-medium transition-all duration-300 cursor-pointer ${
            ...
            <div className="hidden sm:flex items-center gap-4">
              ...
              >
                <span className="text-blue-400 animate-pulse">●</span> +44 7514 856229
              </a>
              <button
                onClick={() => scrollTo("contact")}
                className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded shadow-lg shadow-blue-500/20 transition-all text-xs cursor-pointer"
              >
                Get a Free Quote
              </button>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden border-b border-slate-900 bg-slate-950 px-4 pt-2 pb-6 space-y-2 animate-fade-in">
            ...
            <div className="pt-4 border-t border-slate-900/80 flex flex-col gap-3">
              ...
              <button
                onClick={() => scrollTo("contact")}
                className="w-full py-3.5 bg-blue-600 text-white rounded-xl text-sm font-bold shadow-lg shadow-blue-500/20"
              >
                Get a Free Quote
              </button>
            </div>
      ...
      <main className="flex-grow z-10">
        ...
        {/* HERO SECTION */}
        <section id="home" className="relative py-12 md:py-20 lg:py-28 overflow-hidden border-b border-slate-900 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col gap-6 text-center lg:text-left">
                ...
                <div className="inline-block self-center lg:self-start px-3 py-1 bg-blue-600/10 border border-blue-500/30 rounded text-blue-400 text-xs font-bold uppercase tracking-widest max-w-max">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.1] font-sans tracking-tight">
                  Protecting Your <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600 italic underline underline-offset-8 decoration-slate-850">Home & Business</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mt-2">
                  <button
                    onClick={() => scrollTo("contact")}
                    className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded shadow-xl shadow-blue-600/20 transition-all text-sm tracking-wide cursor-pointer"
                  >
                    Get a Free Quote
                  </button>
                  <a
                ...
                <div className="grid grid-cols-4 gap-4 mt-6 pt-6 border-t border-slate-900 max-w-xl mx-auto lg:mx-0">
                  <div className="text-center">
                    <div className="text-blue-500 font-bold text-xl font-mono">HD 4K</div>
                    <div className="text-[10px] text-slate-500 uppercase tracking-tighter">Resolutions</div>
                  </div>
                  <div className="text-center">
                    <div className="text-blue-500 font-bold text-xl font-mono">24/7</div>
                    <div className="text-[10px] text-slate-500 uppercase tracking-tighter">Monitoring</div>
                  </div>
                  <div className="text-center">
                    <div className="text-blue-500 font-bold text-xl font-mono">FULLY</div>
                    <div className="text-[10px] text-slate-500 uppercase tracking-tighter">Insured</div>
                  </div>
                  <div className="text-center">
                    <div className="text-blue-500 font-bold text-xl font-mono">SMART</div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-6 mt-2 max-w-xl mx-auto lg:mx-0 border-t border-slate-900/60">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <a href="tel:+447514856229" className="text-slate-200 text-sm font-mono font-bold hover:text-blue-400 transition-colors">
                      +44 7514 856229
                    </a>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="text-slate-500 font-mono text-[10px] uppercase">Direct Email</span>
                    <a href="mailto:securemcr@gmail.com" className="text-slate-200 text-sm font-mono font-bold hover:text-blue-400 transition-colors truncate">
                      securemcr@gmail.com
                    </a>
                  </div>
              ...
              <div className="lg:col-span-5 w-full relative">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] bg-blue-500/5 blur-3xl rounded-full pointer-events-none"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 relative flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4 relative z-10">
                  <div className="bg-slate-900/70 border border-slate-800 rounded-3xl p-6 flex flex-col gap-3">
                    <div className="w-12 h-12 bg-blue-600/10 border border-blue-500/20 rounded-2xl flex items-center justify-center text-blue-400 shadow-inner">
                      <Shield className="w-6 h-6" />
                    </div>
                    <h4 className="text-lg font-bold text-slate-100">Homes & Shops</h4>
                  ...
                  <div className="bg-slate-900/70 border border-slate-800 rounded-3xl p-6 flex flex-col gap-3 mt-4">
                    <div className="w-12 h-12 bg-blue-600/10 border border-blue-500/20 rounded-2xl flex items-center justify-center text-blue-400 shadow-inner">
                      <Tv className="w-6 h-6" />
                    </div>
                    <h4 className="text-lg font-bold text-slate-100">Offices & Warehouses</h4>
                    <p className="text-xs text-slate-400 leading-relaxed">
                  ...
                  <div className="bg-slate-900/70 border border-slate-800 rounded-3xl p-6 flex flex-col gap-3">
                    ...
                    <h4 className="text-lg font-bold text-slate-100">Schools & Eateries</h4>
                    <p className="text-xs text-slate-400 leading-relaxed">
                  ...
                  <div className="bg-slate-900/70 border border-slate-800 rounded-3xl p-6 flex flex-col gap-3 mt-4">
                    ...
                    <h4 className="text-lg font-bold text-slate-100">Commercial Sites</h4>
                    <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <div className="lg:col-span-6 flex flex-col gap-5">
                ...
                <ul className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm text-slate-300 font-medium">
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span> Homes & Estates
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span> Retail Shops & Boutiques
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span> Office Units
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span> Industrial Warehouses
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span> Restaurants & Cafes
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span> Schools & Colleges
                  </li>
                </ul>
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4 border-t border-slate-900 mt-2">
                  <button
                    onClick={() => scrollTo("contact")}
                    className="px-6 py-3.5 bg-blue-600 hover:bg-blue-500 active:scale-95 text-white font-bold rounded-xl text-center text-sm transition-all"
                  >
                    Discuss Your Setup
                  </button>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {servicesData.map((service) => (
                <div
                  key={service.id}
                  className="bg-slate-900/50 border border-slate-800 hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/5 p-6 rounded-3xl transition-all duration-300 group flex flex-col justify-between"
                >
                  <div>
                    <div className="w-12 h-12 bg-blue-600/10 border border-blue-500/20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-blue-600/20 group-hover:border-blue-500/40 transition-all duration-300">
                      {renderServiceIcon(service.iconName)}
                    </div>
                    <h3 className="text-xl font-bold text-slate-100 group-hover:text-blue-400 transition-colors mb-3">
                      {service.title}
                    </h3>
                  ...
                  <button
                    ...
                    className="text-xs font-mono font-bold text-blue-400 hover:text-blue-300 flex items-center gap-1.5 transition-colors group/btn cursor-pointer self-start"
                  >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {productsData.map((prod, idx) => (
                <div
                  key={prod.id}
                  className="bg-slate-850/40 border border-slate-800 rounded-2xl p-6 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300 flex flex-col justify-between group"
                >
                  <div>
                    {/* Index & Popular tag line */}
                    <div className="flex justify-between items-center mb-4">
                      <span className="text-blue-400 font-mono text-xs">0{idx + 1} //</span>
                      {idx === 1 && (
                    ...
                    <div className="pt-4 border-t border-slate-800/80">
                      ...
                      <ul className="space-y-2">
                        {prod.features.map((feat, fIdx) => (
                          <li key={fIdx} className="flex gap-2 items-start text-xs text-slate-350 leading-relaxed">
                  ...
                  <div className="mt-6 pt-2">
                    <button
                      ...
                      className="w-full py-3 bg-slate-900 hover:bg-blue-600 hover:text-white border border-slate-800 hover:border-blue-500/30 text-xs font-semibold rounded-xl tracking-wide transition-all duration-300 active:scale-95 cursor-pointer flex items-center justify-center gap-1 text-blue-400"
                    >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              {whyChooseUsData.map((why, idx) => (
                <div
                  key={idx}
                  className="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-300 hover:border-blue-500/10 flex flex-col gap-4"
                >
        ...
        <section id="testimonials" className="py-20 md:py-28 border-b border-slate-900 bg-slate-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
              <div className="max-w-2xl">
                <span className="text-xs font-mono font-bold uppercase tracking-widest text-blue-400">
                ...
                <p className="text-slate-400 mt-3 leading-relaxed">
                  We have proudly completed dozens of camera installations across Manchester and surrounding boroughs. Here are a few reviews from local home and business owners.
                </p>
              </div>

              {/* Testimonial Tag Filters */}
              <div className="flex items-center gap-1.5 bg-slate-900 border border-slate-800 p-1 rounded-xl self-start md:self-auto font-mono text-xs">
              ...
              {testimonialsData
                ...
                .map((test) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-slate-900 mt-6 relative z-10">
                      <div>
                        <h4 className="font-bold text-slate-100">{test.name}</h4>
                        <span className="text-xs text-slate-500 font-mono flex items-center gap-1">
                          <MapPin className="w-3.5 h-3.5 text-blue-400/60" /> {test.location}
                        </span>
                      </div>
                      <div className="flex flex-col items-end gap-1 text-[10px] font-mono">
                        <span className="px-2.5 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 uppercase font-semibold">
                          {test.tag}
                        </span>
        ...
        <section id="faq" className="py-20 md:py-28 border-b border-slate-900 bg-[radial-gradient(ellipse_at_bottom,rgba(15,23,42,0.4),transparent_60%)]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 bg-slate-900 border border-blue-500/10 p-5 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
              <div className="flex gap-3 items-start text-left">
                <div className="p-2.5 bg-blue-500/10 text-blue-400 rounded-xl mt-0.5 flex-shrink-0 hidden sm:block">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-600/20 hover:bg-blue-600/30 text-blue-400 text-xs font-mono rounded-lg border border-blue-500/30 transition-all cursor-pointer"
              >
              ...
              <div className="lg:col-span-5 flex flex-col gap-6 justify-between bg-slate-900/30 border border-slate-800/80 p-6 md:p-8 rounded-3xl">
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="p-3 bg-blue-600/10 text-blue-400 rounded-xl group-hover:scale-105 transition-all">
                        <Phone className="w-5 h-5 animate-pulse" />
                      </div>
                      <div>
                        <span className="text-[10px] text-slate-500 font-mono block">CLICK TO CALL DIRECT</span>
                ...
                {/* Blue CTA Banner from Design Theme */}
                <div className="bg-blue-600 p-6 rounded-2xl relative overflow-hidden shadow-xl shadow-blue-500/10">
                  <div className="relative z-10">
                    <p className="text-blue-100 text-xs font-bold uppercase mb-1 tracking-wider">Need assistance?</p>
                    ...
                    <button
                      ...
                      className="inline-block bg-white hover:bg-slate-100 text-blue-600 font-bold px-6 py-2.5 rounded-xl text-xs shadow-lg transition-colors cursor-pointer"
                    >
                      Contact Specialists
                    </button>
                  </div>
                  <svg className="absolute -right-4 -bottom-4 w-32 h-32 text-blue-500/30" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="lg:col-span-7 bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 relative">
                ...
                {formSubmitted && (
                  <div className="absolute inset-0 bg-slate-900/98 rounded-3xl flex flex-col items-center justify-center p-8 text-center z-20 animate-fade-in">
                    ...
                    <button
                      ...
                      className="mt-6 px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold rounded-xl transition-all cursor-pointer"
                    >
                ...
                <form onSubmit={handleFormSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        } rounded-xl px-4 py-3 text-slate-200 text-sm focus:outline-none focus:border-blue-500/40 transition-colors`}
                      />
                      {formErrors.name && (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-slate-300 text-sm focus:outline-none focus:border-blue-500/40 transition-colors cursor-pointer"
                      >
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 disabled:from-slate-800 disabled:to-slate-800 text-white font-bold rounded-xl active:scale-98 transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer mt-4"
                  >
                    {submitting ? (
                      <>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-16 text-slate-400 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
            ...
            <div className="md:col-span-5 flex flex-col gap-4">
              <div className="flex items-center gap-3" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
                <div className="flex items-center justify-center w-10 h-10 bg-blue-600/10 border border-blue-500/20 text-blue-500 rounded-xl">
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-2 text-xs">
                ...
                <li><button onClick={() => scrollTo("about")} className="hover:text-blue-400 transition-colors">About</button></li>
                <li><button onClick={() => scrollTo("why-choose-us")} className="hover:text-blue-400 transition-colors">Why Choose Us</button></li>
                <li><button onClick={() => scrollTo("testimonials")} className="hover:text-blue-400 transition-colors">Testimonials</button></li>
                <li><button onClick={() => scrollTo("contact")} className="hover:text-blue-400 transition-colors">Booking Survey</button></li>
              </ul>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-2 text-xs">
                <li><button onClick={() => { setFormData(p => ({ ...p, service: "CCTV Installation" })); scrollTo("contact"); }} className="hover:text-blue-400 transition-colors">CCTV Installation</button></li>
                <li><button onClick={() => { setFormData(p => ({ ...p, service: "CCTV Upgrades" })); scrollTo("contact"); }} className="hover:text-blue-400 transition-colors">CCTV Upgrades</button></li>
                <li><button onClick={() => { setFormData(p => ({ ...p, service: "Wireless CCTV" })); scrollTo("contact"); }} className="hover:text-blue-400 transition-colors">Wireless CCTV</button></li>
                <li><button onClick={() => { setFormData(p => ({ ...p, service: "Remote Viewing" })); scrollTo("contact"); }} className="hover:text-blue-400 transition-colors">Remote Mobile Viewing</button></li>
                <li><button onClick={() => { setFormData(p => ({ ...p, service: "Maintenance" })); scrollTo("contact"); }} className="hover:text-blue-400 transition-colors">CCTV Repairs</button></li>
              </ul>
            </div>
            ...
            <div className="md:col-span-3 flex flex-col gap-3">
              ...
              <ul className="space-y-2.5 text-xs">
                <li className="flex gap-2 items-center">
                  ...
                  <a href="tel:+447514856229" className="hover:text-blue-400 transition-colors font-mono font-bold">
                    +44 7514 856229
                  </a>
                </li>
                <li className="flex gap-2 items-center">
                  <Mail className="w-3.5 h-3.5 text-blue-500" />
                  <a href="mailto:securemcr@gmail.com" className="hover:text-blue-400 transition-colors font-mono font-bold truncate">
                    securemcr@gmail.com
                  </a>
                </li>
                <li className="flex gap-2 items-center">
          ...
          <div className="pt-8 border-t border-slate-900/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
            ...
            {/* Social media placeholder icons from Theme */}
            <div className="flex gap-2">
              <span className="bg-slate-900 border border-slate-800 hover:border-blue-500/30 px-2.5 py-1 rounded text-[10px] uppercase font-semibold text-slate-500 hover:text-slate-200 transition-all cursor-pointer">FB</span>
              <span className="bg-slate-900 border border-slate-800 hover:border-blue-500/30 px-2.5 py-1 rounded text-[10px] uppercase font-semibold text-slate-500 hover:text-slate-200 transition-all cursor-pointer">TW</span>
              <span className="bg-slate-900 border border-slate-800 hover:border-blue-500/30 px-2.5 py-1 rounded text-[10px] uppercase font-semibold text-slate-500 hover:text-slate-200 transition-all cursor-pointer">IN</span>
            </div>
          </div>
        </div>
      </footer>
      ...
      {showScrollTop && (
        <button
          ...
          className="fixed bottom-6 left-6 z-40 p-3.5 bg-slate-900/80 hover:bg-blue-600 hover:text-white text-blue-400 border border-blue-500/20 rounded-xl shadow-2xl active:scale-95 transition-all duration-300 pointer-events-auto"
